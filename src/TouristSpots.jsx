    ...
    <div className="tourist-spots-modern">
      ...
      <div className="card-container">
        <div className="spot-card-modern">
          <img src="./css/image/hill.jpg" alt="Penang Hill" />
          <h2>Penang Hill</h2>
          <p>
        ...
        <div className="spot-card-modern">
          <img src="./css/image/escape.jpg" alt="Escape Theme Park" />
        ...
        <div className="spot-card-modern">
          <img src="./css/image/art.jpg" alt="George Town Street Art" />
        ...
        <div className="spot-card-modern">
          <img src="./css/image/taman.jpg" alt="Penang National Park" />
        ...
        <div className="spot-card-modern">
          <img src="./css/image/blue.jpg" alt="Blue Mansion" />
          <h2>Blue Mansion</h2>
          <p>
        ...
        <div className="spot-card-modern">
          <img src="./css/image/beach.jpg" alt="Batu Ferringhi Beach" />
